/*
 * New Scheduling algorithm (EXP-PF) for 5G NR Networks
 *
...
#include <ns3/log.h>
#include <ns3/abort.h>
#include "mmwave-flex-tti-exppf-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("MmWaveFlexTtiExppfMacScheduler");

namespace mmwave {

NS_OBJECT_ENSURE_REGISTERED (MmWaveFlexTtiExppfMacScheduler);

class MmWaveFlexTtiExppfMacCschedSapProvider : public MmWaveMacCschedSapProvider
{

public:
  MmWaveFlexTtiExppfMacCschedSapProvider (MmWaveFlexTtiExppfMacScheduler* scheduler);
...
private:
  MmWaveFlexTtiExppfMacCschedSapProvider ();
  MmWaveFlexTtiExppfMacScheduler* m_scheduler;
};


MmWaveFlexTtiExppfMacCschedSapProvider::MmWaveFlexTtiExppfMacCschedSapProvider ()
{
}

MmWaveFlexTtiExppfMacCschedSapProvider::MmWaveFlexTtiExppfMacCschedSapProvider (MmWaveFlexTtiExppfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
MmWaveFlexTtiExppfMacCschedSapProvider::CschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
MmWaveFlexTtiExppfMacCschedSapProvider::CschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiExppfMacCschedSapProvider::CschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
MmWaveFlexTtiExppfMacCschedSapProvider::CschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
MmWaveFlexTtiExppfMacCschedSapProvider::CschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class MmWaveFlexTtiExppfMacSchedSapProvider : public MmWaveMacSchedSapProvider
{
public:
  MmWaveFlexTtiExppfMacSchedSapProvider (MmWaveFlexTtiExppfMacScheduler* sched);
...
private:
  MmWaveFlexTtiExppfMacSchedSapProvider ();
  MmWaveFlexTtiExppfMacScheduler* m_scheduler;
};

MmWaveFlexTtiExppfMacSchedSapProvider::MmWaveFlexTtiExppfMacSchedSapProvider ()
{
}

MmWaveFlexTtiExppfMacSchedSapProvider::MmWaveFlexTtiExppfMacSchedSapProvider (MmWaveFlexTtiExppfMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
MmWaveFlexTtiExppfMacSchedSapProvider::SchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
MmWaveFlexTtiExppfMacSchedSapProvider::SchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
MmWaveFlexTtiExppfMacSchedSapProvider::SchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
MmWaveFlexTtiExppfMacSchedSapProvider::SchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
MmWaveFlexTtiExppfMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
MmWaveFlexTtiExppfMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}
const unsigned MmWaveFlexTtiExppfMacScheduler::m_macHdrSize = 0;
const unsigned MmWaveFlexTtiExppfMacScheduler::m_subHdrSize = 4;
const unsigned MmWaveFlexTtiExppfMacScheduler::m_rlcHdrSize = 3;

double MmWaveFlexTtiExppfMacScheduler::m_X = 0;
void MmWaveFlexTtiExppfMacScheduler::setX(double x)
{
   m_X = x;
}

MmWaveFlexTtiExppfMacScheduler::MmWaveFlexTtiExppfMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    ...
    m_timeWindow (99.0)
{
  ...
  m_macSchedSapProvider = new MmWaveFlexTtiExppfMacSchedSapProvider (this);
  m_macCschedSapProvider = new MmWaveFlexTtiExppfMacCschedSapProvider (this);
}
...
void
MmWaveFlexTtiExppfMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
MmWaveFlexTtiExppfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveFlexTtiExppfMacScheduler")
    .SetParent<MmWaveMacScheduler> ()
    .AddConstructor<MmWaveFlexTtiExppfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&MmWaveFlexTtiExppfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExppfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExppfMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiExppfMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExppfMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiExppfMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExppfMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExppfMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExppfMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&MmWaveFlexTtiExppfMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
MmWaveFlexTtiExppfMacScheduler::SetMacSchedSapUser (MmWaveMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
MmWaveFlexTtiExppfMacScheduler::SetMacCschedSapUser (MmWaveMacCschedSapUser* sap)
{
...
MmWaveFlexTtiExppfMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

MmWaveMacCschedSapProvider*
MmWaveFlexTtiExppfMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
MmWaveFlexTtiExppfMacScheduler::ConfigureCommonParameters (Ptr<MmWavePhyMacCommon> config)
{
...
void
MmWaveFlexTtiExppfMacScheduler::DoSchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
MmWaveFlexTtiExppfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExppfMacScheduler::DoSchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExppfMacScheduler::DoSchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExppfMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
void
MmWaveFlexTtiExppfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
MmWaveFlexTtiExppfMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
MmWaveFlexTtiExppfMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned MmWaveFlexTtiExppfMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
...
void
MmWaveFlexTtiExppfMacScheduler::DoSchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  ...
  for (std::map<uint16_t, UeSchedInfo>::iterator ueIt = m_ueSchedInfoMap.begin (); ueIt != m_ueSchedInfoMap.end (); ueIt++)
    ...
    // NEW 
    //Compute the X param
    /*double relDeadlines = 0;
    for(std::vector<FlowStats*>::iterator flowIt = m_flowHeap.begin (); flowIt != m_flowHeap.end (); flowIt++){

        std::list<double>::iterator largestDelayIt = std::max_element((*flowIt)->m_txPacketDelays.begin (), (*flowIt)->m_txPacketDelays.end ()); 
        double Alpha = (-log10(0.01*pow((1-0.1),*largestDelayIt))) / *largestDelayIt;

        relDeadlines += ((*flowIt)->m_deadlineUs - (*flowIt)->m_txQueueHolDelay) * Alpha ;
    }
    //if (relDeadlines == 0) MmWaveFlexTtiExppfMacScheduler::setX(1);
    else MmWaveFlexTtiExppfMacScheduler::setX((1/m_flowHeap.size()) * relDeadlines);*/
...
// first allocate symbols in DL and UL subframes to flows based on deadlines, then assign symbol indices
  ...
  // allocate each slot to UE with highest Exppf metric, then update Exppf metrics
  while (symAvail > 0)
    {
      // NEW -------------------------------------------------
    //Compute the X param
      if (m_flowHeap.size() != 0) {
        double relDeadlines = 0;
        for(std::vector<FlowStats*>::iterator flowIt = m_flowHeap.begin (); flowIt != m_flowHeap.end (); flowIt++){
        ...
        MmWaveFlexTtiExppfMacScheduler::setX((1/m_flowHeap.size()) * relDeadlines);
      }
    
    //--------------------------------------------------
      std::sort (m_flowHeap.begin (), m_flowHeap.end (),
                 MmWaveFlexTtiExppfMacScheduler::CompareUeWeightsExppf);
...
//			double ExppfMetric = std::max(ueInfo->m_currTputDl,ueInfo->m_currTputUl) / std::max(1E-9,(ueInfo->m_avgTputDl + ueInfo->m_avgTputDl));
//			std::cout << ueInfo->m_rnti << "=" << ExppfMetric << " ";
//		}
//		std::cout << std::endl;
...
bool
MmWaveFlexTtiExppfMacScheduler::SortRlcBufferReq (MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters i, MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
MmWaveFlexTtiExppfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
MmWaveFlexTtiExppfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
MmWaveFlexTtiExppfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExppfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
MmWaveFlexTtiExppfMacScheduler::DoCschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExppfMacScheduler::DoCschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiExppfMacScheduler::DoCschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::map <uint16_t, struct UeSchedInfo>::iterator itUe = m_ueSchedInfoMap.find (params.m_rnti);
  if (itUe != m_ueSchedInfoMap.end ())
...
void
MmWaveFlexTtiExppfMacScheduler::DoCschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExppfMacScheduler::DoCschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
