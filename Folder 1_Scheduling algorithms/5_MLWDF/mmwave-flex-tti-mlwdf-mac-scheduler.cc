...
#include <ns3/log.h>
#include <ns3/abort.h>
#include "mmwave-flex-tti-mlwdf-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("MmWaveFlexTtiMlwdfMacScheduler");

namespace mmwave {

NS_OBJECT_ENSURE_REGISTERED (MmWaveFlexTtiMlwdfMacScheduler);

class MmWaveFlexTtiMlwdfMacCschedSapProvider : public MmWaveMacCschedSapProvider
{
public:
  MmWaveFlexTtiMlwdfMacCschedSapProvider (MmWaveFlexTtiMlwdfMacScheduler* scheduler);
...
private:
  MmWaveFlexTtiMlwdfMacCschedSapProvider ();
  MmWaveFlexTtiMlwdfMacScheduler* m_scheduler;
};

MmWaveFlexTtiMlwdfMacCschedSapProvider::MmWaveFlexTtiMlwdfMacCschedSapProvider ()
{
}

MmWaveFlexTtiMlwdfMacCschedSapProvider::MmWaveFlexTtiMlwdfMacCschedSapProvider (MmWaveFlexTtiMlwdfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
MmWaveFlexTtiMlwdfMacCschedSapProvider::CschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
MmWaveFlexTtiMlwdfMacCschedSapProvider::CschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiMlwdfMacCschedSapProvider::CschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
MmWaveFlexTtiMlwdfMacCschedSapProvider::CschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
MmWaveFlexTtiMlwdfMacCschedSapProvider::CschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class MmWaveFlexTtiMlwdfMacSchedSapProvider : public MmWaveMacSchedSapProvider
{
public:
  MmWaveFlexTtiMlwdfMacSchedSapProvider (MmWaveFlexTtiMlwdfMacScheduler* sched);
...
private:
  MmWaveFlexTtiMlwdfMacSchedSapProvider ();
  MmWaveFlexTtiMlwdfMacScheduler* m_scheduler;
};

MmWaveFlexTtiMlwdfMacSchedSapProvider::MmWaveFlexTtiMlwdfMacSchedSapProvider ()
{
}

MmWaveFlexTtiMlwdfMacSchedSapProvider::MmWaveFlexTtiMlwdfMacSchedSapProvider (MmWaveFlexTtiMlwdfMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
MmWaveFlexTtiMlwdfMacSchedSapProvider::SchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
MmWaveFlexTtiMlwdfMacSchedSapProvider::SchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
MmWaveFlexTtiMlwdfMacSchedSapProvider::SchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
MmWaveFlexTtiMlwdfMacSchedSapProvider::SchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
MmWaveFlexTtiMlwdfMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
MmWaveFlexTtiMlwdfMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}
const unsigned MmWaveFlexTtiMlwdfMacScheduler::m_macHdrSize = 0;
const unsigned MmWaveFlexTtiMlwdfMacScheduler::m_subHdrSize = 4;
const unsigned MmWaveFlexTtiMlwdfMacScheduler::m_rlcHdrSize = 3;


MmWaveFlexTtiMlwdfMacScheduler::MmWaveFlexTtiMlwdfMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    ...
    m_timeWindow (99.0)
{
  ...
  m_macSchedSapProvider = new MmWaveFlexTtiMlwdfMacSchedSapProvider (this);
  m_macCschedSapProvider = new MmWaveFlexTtiMlwdfMacCschedSapProvider (this);
}
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
MmWaveFlexTtiMlwdfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveFlexTtiMlwdfMacScheduler")
    .SetParent<MmWaveMacScheduler> ()
    .AddConstructor<MmWaveFlexTtiMlwdfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&MmWaveFlexTtiMlwdfMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
MmWaveFlexTtiMlwdfMacScheduler::SetMacSchedSapUser (MmWaveMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
MmWaveFlexTtiMlwdfMacScheduler::SetMacCschedSapUser (MmWaveMacCschedSapUser* sap)
{
...
MmWaveFlexTtiMlwdfMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

MmWaveMacCschedSapProvider*
MmWaveFlexTtiMlwdfMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
MmWaveFlexTtiMlwdfMacScheduler::ConfigureCommonParameters (Ptr<MmWavePhyMacCommon> config)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoSchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoSchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoSchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
void
MmWaveFlexTtiMlwdfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
MmWaveFlexTtiMlwdfMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
MmWaveFlexTtiMlwdfMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned MmWaveFlexTtiMlwdfMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoSchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
...
// first allocate symbols in DL and UL subframes to flows based on deadlines, then assign symbol indices
  ...
  // allocate each slot to UE with highest Mlwdf metric, then update Mlwdf metrics
  while (symAvail > 0)
    {
      std::sort (m_flowHeap.begin (), m_flowHeap.end (),
                 MmWaveFlexTtiMlwdfMacScheduler::CompareUeWeightsMlwdf);
...
//			double MlwdfMetric = std::max(ueInfo->m_currTputDl,ueInfo->m_currTputUl) / std::max(1E-9,(ueInfo->m_avgTputDl + ueInfo->m_avgTputDl));
//			std::cout << ueInfo->m_rnti << "=" << MlwdfMetric << " ";
//		}
//		std::cout << std::endl;
...
bool
MmWaveFlexTtiMlwdfMacScheduler::SortRlcBufferReq (MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters i, MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
MmWaveFlexTtiMlwdfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMlwdfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoCschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoCschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoCschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::map <uint16_t, struct UeSchedInfo>::iterator itUe = m_ueSchedInfoMap.find (params.m_rnti);
  if (itUe != m_ueSchedInfoMap.end ())
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoCschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMlwdfMacScheduler::DoCschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
