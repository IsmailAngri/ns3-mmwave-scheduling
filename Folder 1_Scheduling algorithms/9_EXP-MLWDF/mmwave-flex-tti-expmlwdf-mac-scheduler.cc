/*
 * New Scheduling algorithm (EXP-MLWDF) for 5G NR Networks
 *
...
#include <ns3/log.h>
#include <ns3/abort.h>
#include "mmwave-flex-tti-expmlwdf-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("MmWaveFlexTtiExpmlwdfMacScheduler");

namespace mmwave {

NS_OBJECT_ENSURE_REGISTERED (MmWaveFlexTtiExpmlwdfMacScheduler);

class MmWaveFlexTtiExpmlwdfMacCschedSapProvider : public MmWaveMacCschedSapProvider
{
public:
  MmWaveFlexTtiExpmlwdfMacCschedSapProvider (MmWaveFlexTtiExpmlwdfMacScheduler* scheduler);
...
private:
  MmWaveFlexTtiExpmlwdfMacCschedSapProvider ();
  MmWaveFlexTtiExpmlwdfMacScheduler* m_scheduler;
};

MmWaveFlexTtiExpmlwdfMacCschedSapProvider::MmWaveFlexTtiExpmlwdfMacCschedSapProvider ()
{
}

MmWaveFlexTtiExpmlwdfMacCschedSapProvider::MmWaveFlexTtiExpmlwdfMacCschedSapProvider (MmWaveFlexTtiExpmlwdfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
MmWaveFlexTtiExpmlwdfMacCschedSapProvider::CschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacCschedSapProvider::CschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiExpmlwdfMacCschedSapProvider::CschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacCschedSapProvider::CschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacCschedSapProvider::CschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class MmWaveFlexTtiExpmlwdfMacSchedSapProvider : public MmWaveMacSchedSapProvider
{
public:
  MmWaveFlexTtiExpmlwdfMacSchedSapProvider (MmWaveFlexTtiExpmlwdfMacScheduler* sched);
...
private:
  MmWaveFlexTtiExpmlwdfMacSchedSapProvider ();
  MmWaveFlexTtiExpmlwdfMacScheduler* m_scheduler;
};

MmWaveFlexTtiExpmlwdfMacSchedSapProvider::MmWaveFlexTtiExpmlwdfMacSchedSapProvider ()
{
}

MmWaveFlexTtiExpmlwdfMacSchedSapProvider::MmWaveFlexTtiExpmlwdfMacSchedSapProvider (MmWaveFlexTtiExpmlwdfMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
MmWaveFlexTtiExpmlwdfMacSchedSapProvider::SchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacSchedSapProvider::SchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacSchedSapProvider::SchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacSchedSapProvider::SchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
MmWaveFlexTtiExpmlwdfMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}
const unsigned MmWaveFlexTtiExpmlwdfMacScheduler::m_macHdrSize = 0;
const unsigned MmWaveFlexTtiExpmlwdfMacScheduler::m_subHdrSize = 4;
const unsigned MmWaveFlexTtiExpmlwdfMacScheduler::m_rlcHdrSize = 3;


MmWaveFlexTtiExpmlwdfMacScheduler::MmWaveFlexTtiExpmlwdfMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    ...
    m_timeWindow (99.0)
{
  ...
  m_macSchedSapProvider = new MmWaveFlexTtiExpmlwdfMacSchedSapProvider (this);
  m_macCschedSapProvider = new MmWaveFlexTtiExpmlwdfMacCschedSapProvider (this);
}
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
MmWaveFlexTtiExpmlwdfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveFlexTtiExpmlwdfMacScheduler")
    .SetParent<MmWaveMacScheduler> ()
    .AddConstructor<MmWaveFlexTtiExpmlwdfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&MmWaveFlexTtiExpmlwdfMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::SetMacSchedSapUser (MmWaveMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
MmWaveFlexTtiExpmlwdfMacScheduler::SetMacCschedSapUser (MmWaveMacCschedSapUser* sap)
{
...
MmWaveFlexTtiExpmlwdfMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

MmWaveMacCschedSapProvider*
MmWaveFlexTtiExpmlwdfMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
MmWaveFlexTtiExpmlwdfMacScheduler::ConfigureCommonParameters (Ptr<MmWavePhyMacCommon> config)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoSchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoSchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoSchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
MmWaveFlexTtiExpmlwdfMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
MmWaveFlexTtiExpmlwdfMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned MmWaveFlexTtiExpmlwdfMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoSchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
...
// first allocate symbols in DL and UL subframes to flows based on deadlines, then assign symbol indices
  ...
  // allocate each slot to UE with highest Expmlwdf metric, then update Expmlwdf metrics
  while (symAvail > 0)
    {
      std::sort (m_flowHeap.begin (), m_flowHeap.end (),
                 MmWaveFlexTtiExpmlwdfMacScheduler::CompareUeWeightsExpmlwdf);
...
//			double ExpmlwdfMetric = std::max(ueInfo->m_currTputDl,ueInfo->m_currTputUl) / std::max(1E-9,(ueInfo->m_avgTputDl + ueInfo->m_avgTputDl));
//			std::cout << ueInfo->m_rnti << "=" << ExpmlwdfMetric << " ";
//		}
//		std::cout << std::endl;
...
bool
MmWaveFlexTtiExpmlwdfMacScheduler::SortRlcBufferReq (MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters i, MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoCschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoCschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoCschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::map <uint16_t, struct UeSchedInfo>::iterator itUe = m_ueSchedInfoMap.find (params.m_rnti);
  if (itUe != m_ueSchedInfoMap.end ())
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoCschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiExpmlwdfMacScheduler::DoCschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
