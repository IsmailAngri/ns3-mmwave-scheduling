/*
 * New scheduling algorithm for 5G NR networks
 *
...
#include <ns3/log.h>
#include <ns3/abort.h>
#include "mmwave-flex-tti-maximumweight-mac-scheduler.h"
...
NS_LOG_COMPONENT_DEFINE ("MmWaveFlexTtiMaximumWeightMacScheduler");

namespace mmwave {

NS_OBJECT_ENSURE_REGISTERED (MmWaveFlexTtiMaximumWeightMacScheduler);

class MmWaveFlexTtiMaximumWeightMacCschedSapProvider : public MmWaveMacCschedSapProvider
{
public:
  MmWaveFlexTtiMaximumWeightMacCschedSapProvider (MmWaveFlexTtiMaximumWeightMacScheduler* scheduler);
...
private:
  MmWaveFlexTtiMaximumWeightMacCschedSapProvider ();
  MmWaveFlexTtiMaximumWeightMacScheduler* m_scheduler;
};

MmWaveFlexTtiMaximumWeightMacCschedSapProvider::MmWaveFlexTtiMaximumWeightMacCschedSapProvider ()
{
}

MmWaveFlexTtiMaximumWeightMacCschedSapProvider::MmWaveFlexTtiMaximumWeightMacCschedSapProvider (MmWaveFlexTtiMaximumWeightMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
MmWaveFlexTtiMaximumWeightMacCschedSapProvider::CschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacCschedSapProvider::CschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiMaximumWeightMacCschedSapProvider::CschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacCschedSapProvider::CschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacCschedSapProvider::CschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

class MmWaveFlexTtiMaximumWeightMacSchedSapProvider : public MmWaveMacSchedSapProvider
{
public:
  MmWaveFlexTtiMaximumWeightMacSchedSapProvider (MmWaveFlexTtiMaximumWeightMacScheduler* sched);
...
private:
  MmWaveFlexTtiMaximumWeightMacSchedSapProvider ();
  MmWaveFlexTtiMaximumWeightMacScheduler* m_scheduler;
};

MmWaveFlexTtiMaximumWeightMacSchedSapProvider::MmWaveFlexTtiMaximumWeightMacSchedSapProvider ()
{
}

MmWaveFlexTtiMaximumWeightMacSchedSapProvider::MmWaveFlexTtiMaximumWeightMacSchedSapProvider (MmWaveFlexTtiMaximumWeightMacScheduler* sched)
  : m_scheduler (sched)
{
}

void
MmWaveFlexTtiMaximumWeightMacSchedSapProvider::SchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacSchedSapProvider::SchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
  m_scheduler->DoSchedTriggerReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacSchedSapProvider::SchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacSchedSapProvider::SchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedUlCqiInfoReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacSchedSapProvider::SchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
MmWaveFlexTtiMaximumWeightMacSchedSapProvider::SchedSetMcs (int mcs)
{
  m_scheduler->DoSchedSetMcs (mcs);
}
const unsigned MmWaveFlexTtiMaximumWeightMacScheduler::m_macHdrSize = 0;
const unsigned MmWaveFlexTtiMaximumWeightMacScheduler::m_subHdrSize = 4;
const unsigned MmWaveFlexTtiMaximumWeightMacScheduler::m_rlcHdrSize = 3;


MmWaveFlexTtiMaximumWeightMacScheduler::MmWaveFlexTtiMaximumWeightMacScheduler ()
  : m_nextRnti (0),
    m_subframeNo (0),
    m_tbUid (0),
    m_macSchedSapUser (0),
    ...
    m_timeWindow (99.0)
{
  ...
  m_macSchedSapProvider = new MmWaveFlexTtiMaximumWeightMacSchedSapProvider (this);
  m_macCschedSapProvider = new MmWaveFlexTtiMaximumWeightMacCschedSapProvider (this);
}
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
  m_wbCqiRxed.clear ();
...
TypeId
MmWaveFlexTtiMaximumWeightMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWaveFlexTtiMaximumWeightMacScheduler")
    .SetParent<MmWaveMacScheduler> ()
    .AddConstructor<MmWaveFlexTtiMaximumWeightMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (100),
                   MakeUintegerAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedMcsDl",
                   "Fix MCS to value set in McsDlDefault",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_fixedMcsDl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultDl",
                   "Fixed DL MCS",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_mcsDefaultDl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FixedMcsUl",
                   "Fix MCS to value set in McsUlDefault (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_fixedMcsUl),
                   MakeBooleanChecker ())
    .AddAttribute ("McsDefaultUl",
                   "Fixed UL MCS (for testing)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_mcsDefaultUl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DlSchedOnly",
                   "Only schedule downlink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_dlOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("UlSchedOnly",
                   "Only schedule uplink traffic (for testing)",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_ulOnly),
                   MakeBooleanChecker ())
    .AddAttribute ("FixedTti",
                   "Fix slot size",
                   BooleanValue (false),
                   MakeBooleanAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_fixedTti),
                   MakeBooleanChecker ())
    .AddAttribute ("SymPerSlot",
                   "Number of symbols per slot in Fixed TTI mode",
                   UintegerValue (6),
                   MakeUintegerAccessor (&MmWaveFlexTtiMaximumWeightMacScheduler::m_symPerSlot),
                   MakeUintegerChecker<uint8_t> ())
  ;
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::SetMacSchedSapUser (MmWaveMacSchedSapUser* sap)
{
  m_macSchedSapUser = sap;
}

void
MmWaveFlexTtiMaximumWeightMacScheduler::SetMacCschedSapUser (MmWaveMacCschedSapUser* sap)
{
...
MmWaveFlexTtiMaximumWeightMacScheduler::GetMacSchedSapProvider ()
{
  return m_macSchedSapProvider;
}

MmWaveMacCschedSapProvider*
MmWaveFlexTtiMaximumWeightMacScheduler::GetMacCschedSapProvider ()
{
  return m_macCschedSapProvider;
}

void
MmWaveFlexTtiMaximumWeightMacScheduler::ConfigureCommonParameters (Ptr<MmWavePhyMacCommon> config)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoSchedDlRlcBufferReq (const struct MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoSchedUlMacCtrlInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoSchedDlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoSchedUlCqiInfoReq (const struct MmWaveMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoSchedSetMcs (int mcs)
{
  if (mcs >= 0 && mcs <= 28)
    {
      m_mcsDefaultDl = mcs;
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
uint8_t
MmWaveFlexTtiMaximumWeightMacScheduler::UpdateDlHarqProcessId (uint16_t rnti)
{
...
uint8_t
MmWaveFlexTtiMaximumWeightMacScheduler::UpdateUlHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
unsigned MmWaveFlexTtiMaximumWeightMacScheduler::CalcMinTbSizeNumSym (unsigned mcs, unsigned bufSize, unsigned &tbSize)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoSchedTriggerReq (const struct MmWaveMacSchedSapProvider::SchedTriggerReqParameters& params)
{
...
// first allocate symbols in DL and UL subframes to flows based on deadlines, then assign symbol indices
  ...
  // allocate each slot to UE with highest MaximumWeight metric, then update MaximumWeight metrics
  while (symAvail > 0)
    {
      std::sort (m_flowHeap.begin (), m_flowHeap.end (),
                 MmWaveFlexTtiMaximumWeightMacScheduler::CompareUeWeightsMaximumWeight);
...
//			double MaximumWeightMetric = std::max(ueInfo->m_currTputDl,ueInfo->m_currTputUl) / std::max(1E-9,(ueInfo->m_avgTputDl + ueInfo->m_avgTputDl));
//			std::cout << ueInfo->m_rnti << "=" << MaximumWeightMetric << " ";
//		}
//		std::cout << std::endl;
...
bool
MmWaveFlexTtiMaximumWeightMacScheduler::SortRlcBufferReq (MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters i, MmWaveMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::RefreshDlCqiMaps (void)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoCschedCellConfigReq (const struct MmWaveMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoCschedUeConfigReq (const struct MmWaveMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoCschedLcConfigReq (const struct MmWaveMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::map <uint16_t, struct UeSchedInfo>::iterator itUe = m_ueSchedInfoMap.find (params.m_rnti);
  if (itUe != m_ueSchedInfoMap.end ())
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoCschedLcReleaseReq (const struct MmWaveMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
MmWaveFlexTtiMaximumWeightMacScheduler::DoCschedUeReleaseReq (const struct MmWaveMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
