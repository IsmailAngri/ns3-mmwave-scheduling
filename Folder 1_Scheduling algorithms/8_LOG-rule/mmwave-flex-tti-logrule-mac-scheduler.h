...
#ifndef SRC_MMWAVE_MODEL_MMWAVE_LOGRULE_MAC_SCHEDULER_H_
#define SRC_MMWAVE_MODEL_MMWAVE_LOGRULE_MAC_SCHEDULER_H_
...
class MmWaveFlexTtiLogruleMacScheduler : public MmWaveMacScheduler
{
public:
  ...
  MmWaveFlexTtiLogruleMacScheduler ();

  virtual ~MmWaveFlexTtiLogruleMacScheduler ();
  ...
  friend class MmWaveFlexTtiLogruleMacSchedSapProvider;
  friend class MmWaveFlexTtiLogruleMacCschedSapProvider;
...
private:
  ...
  static bool CompareUeWeightsLogrule (FlowStats* lflow, FlowStats* rflow)
  {
    ...
    double lLogruleMetric = std::max (lflow->m_ueSchedInfo->m_currTputDl,lflow->m_ueSchedInfo->m_currTputUl) / std::max (1E-9,(lflow->m_ueSchedInfo->m_avgTputDl + lflow->m_ueSchedInfo->m_avgTputDl));
    double rLogruleMetric = std::max (rflow->m_ueSchedInfo->m_currTputDl,rflow->m_ueSchedInfo->m_currTputUl) / std::max (1E-9,(rflow->m_ueSchedInfo->m_avgTputDl + rflow->m_ueSchedInfo->m_avgTputDl));
    
    double lNewMetric = lLogruleMetric * log10(1 + (lAlpha * lRelDeadline));
    double rNewMetric = rLogruleMetric * log10(1 + (rAlpha * rRelDeadline));
...
#endif /* SRC_MMWAVE_MODEL_MMWAVE_LOGRULE_MAC_SCHEDULER_H_ */
